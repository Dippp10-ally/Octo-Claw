      ...
      <section className="relative">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-16 text-center">
          ...
          <div className="mx-auto mt-14 grid max-w-5xl gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-border bg-gradient-card p-5 text-left shadow-elegant backdrop-blur">
            ...
            <div className="relative rounded-2xl border border-border bg-gradient-card p-5 text-left shadow-elegant backdrop-blur">
              <div className="mb-3 flex items-center gap-2 text-xs text-muted-foreground">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {agents.map((a) => (
              <div
                key={a.name}
                className="rounded-2xl border border-border bg-card/60 p-6 backdrop-blur transition-smooth hover:border-accent hover:shadow-elegant"
              >
      ...
      <section id="stack" className="mx-auto max-w-7xl px-6 py-24">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {stack.map((s) => (
            <div
              key={s.label}
              className="flex items-center gap-4 rounded-2xl border border-border bg-gradient-card p-5 transition-smooth hover:border-primary"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-primary/20 text-primary">
                <s.icon className="h-5 w-5" />
              </div>
              <div>
